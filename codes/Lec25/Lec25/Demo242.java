/*
// Polymorphism concept // method overloading
*/
class Point {
    int x,y;
    ...
    float distance ( int x, int y)	{	// One definition of distance
		int  dx = this.x -  x;
	    int  dy = this.y - y;	 
...
class Point3D extends Point {
    ...
    float distance (int x,int y, int z )  {	// Another definition of distance
		int dx = this.x - x;
		int dy = this.y - y;
		int dz = this.z - z ;
